                  ...
                  <div className="flex flex-col lg:flex-row items-center justify-around gap-10">
                    ...
                    <div className=" w-2/3">
                      ...
                      <div className="flex gap-10">
                        ...
                        <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-400">
                          Race:{" "}
                          <span className="text-pink-700">{data.Race}</span>
                        </p>
                      </div>
                      <div className="flex gap-10">
                        <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-400">
                          Height:{" "}
                          <span className="text-pink-700">{data.Height}</span>{" "}
                          CM
                        </p>
                        <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-400">
                          Weight:{" "}
                          <span className="text-pink-700">{data.Weight}</span>{" "}
                          KG
                        </p>
                      </div>
                      <div className="flex gap-10">
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                  <div className="relative z-0 w-full mb-5 group">
                    <input
                      ...
                      placeholder=" " defaultValue={user.displayName}
                    />
                    <label
                      alt="Name"
                      htmlFor="name"
